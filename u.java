...
public final class u {
    ...
    public u(byte by, byte by2) {
        this.var_z_a = z.a("animal30", "/newsprite/");
        this.var_z_b = z.a("animal31", "/newsprite/");
        this.e = w.var_byte_arr_h[3];
    }
    ...
    public final void a(Graphics graphics, int n2, int n3) {
        ...
        z2.var_int_c = n4;
        this.var_z_b.a(n2 + 178, n3 + 90);
        this.var_z_a.a(n2 + 180, n3 + 85);
    ...
    public final void a(Graphics graphics, Sprite sprite, Sprite sprite2) {
        if (this.var_boolean_b) {
            if (this.var_byte_a != 10) {
                ...
                if (w.var_byte_arr_e[3] / 10 != 0) {
                    sprite2.setFrame(w.var_byte_arr_e[3] / 10);
    ...
    public final boolean boolean_a() {
        if (!this.var_boolean_a) {
            if (this.var_short_a == 0 && !this.var_boolean_a) {
                this.var_short_a = w.var_byte_arr_g[3];
            }
