...
public final class ae {
    ...
    public ae(byte by, byte by2) {
        this.var_z_a = z.a("animal10", "/newsprite/");
        this.var_z_b = z.a("animal11", "/newsprite/");
        this.e = w.var_byte_arr_h[0];
    }
    ...
    public final void a(Graphics graphics, int n2, int n3) {
        ...
        z2.var_int_c = n4;
        this.var_z_b.a(n2 + 175, n3 + 120);
        this.var_z_a.a(n2 + 190 + this.f, n3 + 110);
    ...
    public final void a(Graphics graphics, Sprite sprite, Sprite sprite2) {
        if (this.var_boolean_c) {
            if (this.var_byte_a != 10) {
                ...
                if (w.var_byte_arr_e[0] / 10 != 0) {
                    sprite2.setFrame(w.var_byte_arr_e[0] / 10);
    ...
    public final boolean boolean_a() {
        if (!this.var_boolean_b) {
            if (this.var_short_a == 0 && !this.var_boolean_b) {
                this.var_short_a = w.var_byte_arr_g[0];
            }
